...
public class JimunDanwonView extends RelativeLayout {

    private FragmentActivity activity;

//    private DanwonStudyQuestionJimun dayStudyQuestionJimun;
//    private ConfirmQuestionJimun confirmQuestionJimun;
    ...
    public JimunDanwonView(FragmentActivity activity) {
        super(activity);
     ...
     */
    public void setDanwonStudyData(DanwonStudyQuestionJimun data) {
//        this.dayStudyQuestionJimun = data;
